...
const darkTheme = {
  ...
  background: `
    linear-gradient(180deg, rgba(154, 18, 179, 1), rgba(0, 0, 10, 0.9)),
    linear-gradient(333deg, rgba(154, 18, 179, 1), rgba(180, 255, 217, 0.08)),
    radial-gradient(circle at 77% 89%, rgba(154, 18, 179, 1), rgba(125, 163, 169, 0) 50%),
    radial-gradient(circle at 15% 95%, rgba(154, 18, 179, 1), rgba(125, 163, 169, 0) 43%),
    radial-gradient(circle at 65% 23%, rgba(154, 18, 179, 1), rgba(137, 151, 119, 0) 70%),
